...
if 요일 == '토요일' or 요일 == '일요일' :
    bot.send_message(chat_id = chat_id, text = "금일은 운영하지 않습니다.")
    ...
    add_handler('dd', cmd_task_buttons)
    add_handler('menu', cmd_task_buttons)
    add_handler('rr', cmd_task_buttons)
    add_handler('gg', cmd_task_buttons)
